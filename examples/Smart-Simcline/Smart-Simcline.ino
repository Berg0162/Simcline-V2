 ...
 *  
 *  Requirements: Zwift app or alike, operational Simcline and a CPS and a supported Indoor Trainer
 ...
 *  4) Simcline and Trainer will pair as reported in the output
...
// Create instance of Lifter class
...
void setup() {
  ...
  LOG("  NimBLE: CPS and FTMS"); 
   //Show Name and SW version on TFT
  presentation->ShowMessageWindow("SIMCLINE", "FTMS", CODE_VERSION, 500);
#endif
 #ifdef ENABLE_HRM
  LOG(" Enabled: HRM");
#endif
...
void checkMITMdataChanged(void) { 
      ...
      presentation->ShowIconsOnTopBar(operations->isTrainerConnected(), operations->isLaptopConnected(), \
                                      operations->isSmartphoneConnected());
}
