# <img src="https://github.com/Berg0162/simcline/blob/master/images/SC_logo.png" width="64" height="64" alt="SIMCLINE Icon"> &nbsp; SIMCLINE for Bluetooth Smart trainers <br> based on the Adafruit Feather ESP32 V2 board with OLED display.

# Setup Feather ESP32 V2 for Simcline-V2
...
<p align=center>
<img src="../images/Feather_ESP32_V2_Tools_Settings.jpg" align="left" width="400" height="650" alt="Feather ESP32 V2 Tools Menu">
</p>
<br clear="left">
...
<b>Adafruit ESP32 Feather V2</b><br>
During a few years now we have gained a lot of experience with the very stable and reliable <b>Adafruit ESP32 Feather V2</b> - with onboard the fabulous ESP32 WROOM module. The ESP32 has both WiFi and Bluetooth Classic/LE support. Compared to the original Feather (Huzzah) with only 4 MB Flash and no PSRAM, the V2 has 8 MB Flash and 2 MB PSRAM. Packed with everything people love about Feathers: built in USB-to-Serial converter, automatic bootloader reset, Lithium Ion/Polymer charger, and just about all of the GPIOs brought out. [Adafruit Feather ESP32 V2](https://learn.adafruit.com/adafruit-esp32-feather-v2) <br>
