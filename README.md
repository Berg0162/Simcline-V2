...
+ Install the Simcline-V2 library from this repository
++ Download as .zip and extract to Arduino/libraries folder, or in Arduino IDE from Sketch menu -> `Include library` -> `Add .Zip library`.<br>
