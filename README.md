...
The Simcline-V2 library comes with an Android companion app for configuring and controlling its features. <br>
See: [android](https://github.com/Berg0162/Simcline-V2/blob/main/android/readme.md)
