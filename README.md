...
+ Install the ESP32 NimBLE-Arduino library (<b>Latest Version 2.#.#</b>), Go to 'Sketch menu' -> 'Include Library' -> 'Manage Libraries', search for NimBLE-Arduino and install. [NimBLE](https://github.com/h2zero/NimBLE-Arduino#arduino-installation)
